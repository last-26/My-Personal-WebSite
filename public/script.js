...
const translations = {
    tr: {
        ...
        "case.smtbot.stat3.k": "Test yüzeyi",
        "case.smtbot.stat3.v": "63 / ~975",
        "case.smtbot.stat4.k": "Strateji",
        "case.smtbot.stat4.v": "Price Action",
        "case.smtbot.arch.tag": "01 · Mimari",
        "case.smtbot.arch.h": "Uçtan uca işlem döngüsü, sistem seviyesinde gösteriliyor.",
        "case.smtbot.arch.lead": "Akış; Bybit V5 API, veri hazırlama, private karar sınırı, risk otoritesi, yürütme ve operasyon katmanları olarak okunur.",
        "case.smtbot.arch.exchange.h": "Bybit V5",
        "case.smtbot.arch.exchange.body": "Piyasa verisi, emirler, pozisyonlar ve cüzdan durumu için ana exchange arayüzü.",
        "case.smtbot.arch.data.h": "Veri Katmanı",
        "case.smtbot.arch.data.body": "Stream normalizasyonu, mum buffer'ları, cache ve market state üretimi.",
        "case.smtbot.arch.core.h": "Private Karar Çekirdeği",
        "case.smtbot.arch.core.body": "Karar mantığı kapalıdır; vitrinde yalnızca giriş/çıkış sınırı görünür.",
        "case.smtbot.arch.risk.h": "Risk Otoritesi",
        "case.smtbot.arch.risk.body": "RR, boyutlandırma, maruziyet limitleri, devre kesiciler ve pozisyon yaşam döngüsü.",
        "case.smtbot.arch.ops.h": "Yürütme &amp; Operasyon",
        "case.smtbot.arch.ops.body": "Emir yönlendirme, mutabakat, SQLite kayıtları, pano ve diagnostik raporlar.",
        "case.smtbot.boundary.tag": "02 · Public/Private Sınır",
        "case.smtbot.boundary.h": "Mühendisliği değerlendirecek kadar açık. Stratejiyi yeniden üretmeye yetecek kadar değil.",
        "case.smtbot.boundary.lead": "Showcase, sistem kalitesini anlatır; alım-satım karar mantığını, üretim parametrelerini ve kapalı raporları dışarı çıkarmaz.",
        "case.smtbot.boundary.public": "Showcase'te görünen",
        "case.smtbot.boundary.public.list": "<li>Sistem mimarisi ve modül haritası</li><li>Runtime modeli ve teknoloji ayak izi</li><li>Risk kontrolleri, operasyon akışı, pano ve kayıt yapısı</li>",
        "case.smtbot.boundary.private": "Private repoda kalan",
        "case.smtbot.boundary.private.list": "<li>Karar çekirdeğinin implementasyonu</li><li>Üretim parametreleri ve iç sıralama mantığı</li><li>Hesap kayıtları ve kapalı performans raporları</li>",
        "case.smtbot.stack.tag": "03 · Yetkinlik Haritası",
        "case.smtbot.stack.h": "Görünen teknik yüzey, sorumluluklarına göre ayrıldı.",
        "case.smtbot.stack.lead": "Burada gösterilen katmanlar stratejiyi değil; veri, risk, yürütme, kayıt, pano ve test disiplinini temsil eder.",
        "case.smtbot.stack.data": "Veri Katmanı",
        "case.smtbot.stack.data.list": "<li><strong>Bybit V5 WS</strong> <span>kapalı mum akışı ve market feed</span></li><li><strong>KlineBuffer + cache</strong> <span>rolling pencere ve yeniden bağlanma toparlama</span></li><li><strong>MarketStateBuilder</strong> <span>ham exchange verisinden normalize state</span></li>",
        "case.smtbot.stack.risk": "Risk &amp; Portföy",
        "case.smtbot.stack.risk.list": "<li><strong>RR sistemi</strong> <span>standartlaştırılmış ödül/risk hesabı</span></li><li><strong>Pozisyon boyutu</strong> <span>sermaye ve maruziyet kontrollü boyutlandırma</span></li><li><strong>Devre kesiciler</strong> <span>kayıp, seri, drawdown ve cooldown kapıları</span></li>",
        "case.smtbot.stack.execution": "Yürütme",
        "case.smtbot.stack.execution.list": "<li><strong>pybit V5 client</strong> <span>emir, pozisyon, cüzdan ve fill erişimi</span></li><li><strong>Order router</strong> <span>tek kontrollü emir geçiş noktası</span></li><li><strong>Position monitor</strong> <span>exchange state ile mutabakat</span></li>",
        "case.smtbot.stack.ops": "Operasyon &amp; Doğrulama",
        "case.smtbot.stack.ops.list": "<li><strong>aiosqlite journal</strong> <span>runtime olayları için kalıcı kayıt</span></li><li><strong>FastAPI + uvicorn</strong> <span>salt okunur operasyon panosu</span></li><li><strong>pytest</strong> <span>63 dosya, yaklaşık 975 test vakası</span></li>",
        "case.smtbot.proof.tag": "04 · Mühendislik Kanıtı",
        "case.smtbot.proof.h": "Kanıt, gizli stratejide değil; görünen işletim kalitesinde.",
        "case.smtbot.proof.data.h": "API kontrollü veri yolu",
        "case.smtbot.proof.data.body": "Market verisi ve state hazırlığı doğrudan exchange API'leri üzerinden yönetilir.",
        "case.smtbot.proof.risk.h": "Emirden önce risk kapısı",
        "case.smtbot.proof.risk.body": "RR, boyutlandırma, maruziyet ve cooldown kontrolleri emir yönlendirmesinden önce çalışır.",
        "case.smtbot.proof.ops.h": "İzlenebilir operasyon hafızası",
        "case.smtbot.proof.ops.body": "SQLite kayıtları ve pano; aksiyonları, mutabakatı ve raporları denetlenebilir tutar.",
        "case.smtbot.proof.validation.h": "Testle korunan yüzey",
        "case.smtbot.proof.validation.body": "Runtime, risk, yürütme ve operasyon akışlarını kapsayan 63 test dosyası.",
        "case.smtbot.workflow.tag": "05 · İş Akışı",
        "case.smtbot.workflow.h": "Bağlantıdan gözleme kadar kontrollü demo akışı.",
        "case.smtbot.workflow.lead": "Akış, önce API erişimini doğrular; ardından yapılandırma, bağlantı testi, dry-run ve pano izlemesiyle ilerler.",
        "case.smtbot.workflow.step1": "BYBIT API",
        "case.smtbot.workflow.step2": "config + env",
        "case.smtbot.workflow.step3": "bağlantı testi",
    ...
    en: {
        ...
        "case.smtbot.stat2.v": "30 x 6 TF",
        "case.smtbot.stat3.k": "Test surface",
        "case.smtbot.stat3.v": "63 / ~975",
        "case.smtbot.stat4.k": "Strategy",
        "case.smtbot.stat4.v": "Price Action",
        "case.smtbot.arch.tag": "01 · Architecture",
        "case.smtbot.arch.h": "End-to-end trading loop, shown at system level.",
        "case.smtbot.arch.lead": "Read the flow as Bybit V5 API, data preparation, private decision boundary, risk authority, execution, and operations.",
        "case.smtbot.arch.exchange.h": "Bybit V5",
        "case.smtbot.arch.exchange.body": "Primary exchange interface for market data, orders, positions, and wallet state.",
        "case.smtbot.arch.data.h": "Data Plane",
        "case.smtbot.arch.data.body": "Stream normalization, candle buffers, cache, and market-state assembly.",
        "case.smtbot.arch.core.h": "Private Decision Core",
        "case.smtbot.arch.core.body": "Decision logic stays closed; only its input/output boundary is shown.",
        "case.smtbot.arch.risk.h": "Risk Authority",
        "case.smtbot.arch.risk.body": "RR, sizing, exposure limits, circuit breakers, and position lifecycle gates.",
        "case.smtbot.arch.ops.h": "Execution &amp; Ops",
        "case.smtbot.arch.ops.body": "Order routing, reconciliation, SQLite records, dashboard, and diagnostic reports.",
        "case.smtbot.boundary.tag": "02 · Public/Private Boundary",
        "case.smtbot.boundary.h": "Open enough to evaluate the engineering. Closed enough to protect the strategy.",
        "case.smtbot.boundary.lead": "The showcase explains system quality, not trading decision logic, production parameters, or internal reports.",
        "case.smtbot.boundary.public": "Visible in showcase",
        "case.smtbot.boundary.public.list": "<li>System architecture and module map</li><li>Runtime model and technology footprint</li><li>Risk controls, ops workflow, dashboard, and journal structure</li>",
        "case.smtbot.boundary.private": "Kept in private repo",
        "case.smtbot.boundary.private.list": "<li>Decision core implementation</li><li>Production parameters and internal ranking logic</li><li>Account records and private performance reports</li>",
        "case.smtbot.stack.tag": "03 · Capability Map",
        "case.smtbot.stack.h": "The visible technical surface is grouped by responsibility.",
        "case.smtbot.stack.lead": "The exposed layers represent data, risk, execution, journal, dashboard, and test discipline without revealing strategy logic.",
        "case.smtbot.stack.data": "Data Plane",
        "case.smtbot.stack.data.list": "<li><strong>Bybit V5 WS</strong> <span>closed-candle stream and market feed</span></li><li><strong>KlineBuffer + cache</strong> <span>rolling windows and reconnect recovery</span></li><li><strong>MarketStateBuilder</strong> <span>normalized state from raw exchange rows</span></li>",
        "case.smtbot.stack.risk": "Risk &amp; Portfolio",
        "case.smtbot.stack.risk.list": "<li><strong>RR system</strong> <span>standardized reward/risk calculation</span></li><li><strong>Position sizing</strong> <span>equity and exposure-aware sizing</span></li><li><strong>Circuit breakers</strong> <span>loss, streak, drawdown, and cooldown gates</span></li>",
        "case.smtbot.stack.execution": "Execution",
        "case.smtbot.stack.execution.list": "<li><strong>pybit V5 client</strong> <span>order, position, wallet, and fill access</span></li><li><strong>Order router</strong> <span>single controlled order gateway</span></li><li><strong>Position monitor</strong> <span>reconciliation against exchange state</span></li>",
        "case.smtbot.stack.ops": "Ops &amp; Validation",
        "case.smtbot.stack.ops.list": "<li><strong>aiosqlite journal</strong> <span>persistent records for runtime events</span></li><li><strong>FastAPI + uvicorn</strong> <span>read-only operations dashboard</span></li><li><strong>pytest</strong> <span>63 files, roughly 975 test cases</span></li>",
        "case.smtbot.proof.tag": "04 · Engineering Proof",
        "case.smtbot.proof.h": "The proof is visible operating quality, not exposed strategy detail.",
        "case.smtbot.proof.data.h": "API-owned data path",
        "case.smtbot.proof.data.body": "Market ingestion and state preparation are owned directly through exchange APIs.",
        "case.smtbot.proof.risk.h": "Risk gate before orders",
        "case.smtbot.proof.risk.body": "RR, sizing, exposure, and cooldown checks run before order routing.",
        "case.smtbot.proof.ops.h": "Inspectable ops memory",
        "case.smtbot.proof.ops.body": "SQLite records and dashboard views keep actions, reconciliation, and reports auditable.",
        "case.smtbot.proof.validation.h": "Test-guarded surface",
        "case.smtbot.proof.validation.body": "63 test files cover runtime, risk, execution, and operations flows.",
        "case.smtbot.workflow.tag": "05 · Workflow",
        "case.smtbot.workflow.h": "Controlled demo path from connection to observation.",
        "case.smtbot.workflow.lead": "The workflow validates API access first, then moves through configuration, connection checks, dry-run, and dashboard monitoring.",
        "case.smtbot.workflow.step1": "BYBIT API",
        "case.smtbot.workflow.step2": "config + env",
        "case.smtbot.workflow.step3": "connection check",
