...
const translations = {
    ...
    en: {
        ...
        "about.intro": "A results-driven Computer Engineer specializing in Artificial Intelligence, NLP & Large Language Models.",
        "about.description": "Graduated from Eskişehir Osmangazi University with a BSc in Computer Engineering. I have a proven track record of designing end-to-end AI architectures, high-performance RAG pipelines, and Multi-LLM orchestrations. My core strength lies in bridging complex machine learning models with scalable full-stack development (React, FastAPI, PostgreSQL) to deliver data-driven solutions with millisecond-level latency and over 95% accuracy.",
